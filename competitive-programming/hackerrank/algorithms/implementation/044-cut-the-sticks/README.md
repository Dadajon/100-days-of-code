...
The next line contains *n* space-separated integers, each an *arr*[*i*], where each value represents the length of the ![equation](https://latex.codecogs.com/svg.latex?%5Cinline%20i%5E%7Bth%7D) stick.
