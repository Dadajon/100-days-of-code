...
Complete the ***utopian_tree*** function in the editor below. It should return the integer height of the tree after the input number of growth cycles.
...
- ![equation](https://latex.codecogs.com/gif.latex?0%20%5Cleq%20n%20%5Cleq%2060)
